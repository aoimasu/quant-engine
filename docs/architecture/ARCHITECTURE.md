...
**Generated:** 2026-07-18 (refreshed for the QE-430..454 GP-indicator-evolution program; original 2026-07-05); internal-contract refresh 2026-07-31 for the QE-473..489 panel-review R5 batch (see Recent changes at the end)
...
`crates/wfo/src/{backtest,gp/mod,gp/archive,gp/deflation,gp/descriptor,gp/freeze,gp/gates,gp/variation}.rs`, `crates/formula-pool/src/{lib,lifecycle,governance_record}.rs`, `crates/run-protocol/src/lib.rs`, `crates/signal/src/{indicator/expr,regime}.rs`, `crates/validation/src/{basis,cpcv,pbo}.rs`,
...
`docs/current-state.html`, `docs/architecture/qe-450-gp-indicator-evolution-design.md`, `docs/mds/reviewed/qe-45{1,2,3,4}-*.md`, `docs/reviews/panel-review-2026-07-31.md`.
