...
| Ticket | Title | Depends on | Status |
|--------|-------|------------|:------:|
| [QE-451](./architecture/qe-450-gp-indicator-evolution-design.md#4-design) | `evolve` CLI job + GP engine + frozen-pool artifact — **epic, phased**: Phases 0 ✅ + 1a ✅ (see [`reviewed/qe-451-phase0.md`](./mds/reviewed/qe-451-phase0.md), [`qe-451-phase1a.md`](./mds/reviewed/qe-451-phase1a.md)), Phase 1b pending  *(P2 — research/sandbox first; production blocked on deflation prereqs)* | QE-006, QE-106, QE-107, QE-120, QE-113, QE-430, QE-432, QE-434, QE-436, QE-439 | — |
